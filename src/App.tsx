  ...
  return (
    <div className="h-screen flex items-center justify-center">
      ...
      <form className="w-2/5">
        ...
        <button type="submit" className="text-white bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-md w-full sm:w-auto px-5 py-2.5 text-center">Enviar</button>
      </form>
    </div>
  )
}
